...
<<<<<<< HEAD
		<input class="btn my-btn" onclick="window.location.href = '/eRSPG/proposal/proposals'" style= "margin-right:15px" type="button" value="View Proposals"/>
...
>>>>>>> ffbe57566d50e5c91debddedfe77ea3906724aed
	</div>
</div>
