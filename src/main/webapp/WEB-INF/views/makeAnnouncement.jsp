...
<div class="wrapper">
    ...
    <nav id="sidebar" class="sidebar">
        ...
        <ul class="list-unstyled components">
            <li><a class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/admin/home'" value="Admin">Home</a></li>
            <li><a class="btn my-btn" type="button">Manage Committee</a></li>
            <li><a class="btn my-btn" type="button" href="#">Proposals</a></li>
            <li class="active"><a class="btn my-btn" type="button" onclick="window.location.href = '/eRSPG/admin/makeAnnouncement'" value="Announcement">Make Announcement</a></li>
        </ul>
    </nav>
