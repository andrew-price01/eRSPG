...
<div class="wrapper">
    ...
    <nav id="sidebar" class="sidebar">
        ...
        <ul class="list-unstyled components">
            <li class="active"><a class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/chair/home'" value="Chairman Home">Home</a></li>
    ...
    <div id="content" class="main">
        ...
        <div>
            <input class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/chair/assignproposal'" value="Assign Proposals" />

            <input class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/chair/reviewproposal'" value="Review Proposals" />
        </div>

        <br>

        <div>
            <input class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/chair/committee'" value="Manage Committee" />
