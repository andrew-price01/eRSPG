...
import eRSPG.Repository.PersistentTokenRepository;
import eRSPG.Repository.UserDAO;
import eRSPG.Repository.UserImpl;
import eRSPG.model.User;
import eRSPG.util.PersistentToken;
...
public class CustomPersistentRememberMeServices extends
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request, HttpServletResponse response) {
        ...
        String login = token.getUser().getLoginName();
